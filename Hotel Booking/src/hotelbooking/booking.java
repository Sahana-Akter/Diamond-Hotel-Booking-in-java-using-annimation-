...
{
    JComboBox comboid,gendercombo, croom;
    JTextField tfnumber,tfname,tfcountry,tfdeposit;
    //Choice croom;
    JLabel checkintime;
    JButton add,cancle,update;
    booking()
    {
        getContentPane().setBackground(Color.WHITE);
        setLayout(null);

        JLabel text=new JLabel("NEW BOOKING FORM");
        ...
        String options[]={"NID","Passport","Birth Certificate"};
        ...
        String Options[] = {"Single", "Double","Luxury"};
        croom = new JComboBox(Options);
        ...
        cancle.setBounds(350,410,120,30);
